...
import com.lovcreate.teacher.adapter.SmallVideoViewAdapter;
import com.lovcreate.teacher.adapter.SmallVideoViewDecoration;
import com.lovcreate.teacher.constant.ConstantApp;
import com.lovcreate.teacher.model.AGEventHandler;
import com.lovcreate.teacher.model.Message;
import com.lovcreate.teacher.model.User;
import com.lovcreate.teacher.model.WorkerThread;
import com.lovcreate.teacher.propeller.Constant;
import com.lovcreate.teacher.propeller.UserStatusData;
import com.lovcreate.teacher.propeller.VideoInfoData;
import com.lovcreate.teacher.propeller.preprocessing.VideoPreProcessing;
import com.lovcreate.teacher.propeller.ui.RtlLinearLayoutManager;
import com.lovcreate.teacher.view.GridVideoViewContainer;
import com.lovcreate.teacher.view.VideoViewEventListener;
...
public class ChatActivity extends BaseActivity implements AGEventHandler {
    ...
    protected void initUIandEvent() {
        ...
        mGridVideoViewContainer.setItemEventHandler(new VideoViewEventListener() {
            ...
            public void onItemDoubleClick(View v, Object item) {
                ...
                int uid = (user.mUid == 0) ? workerThread.getEngineConfig().mUid : user.mUid;
        ...
        workerThread.getRtcEngine().setupLocalVideo(new VideoCanvas(surfaceV, VideoCanvas.RENDER_MODE_HIDDEN, 0));
        ...
        workerThread.preview(true, surfaceV, 0);

        workerThread.joinChannel(channelName, workerThread.getEngineConfig().mUid);
    ...
    protected int virtualKeyHeight() {
        boolean hasPermanentMenuKey = ViewConfigurationCompat
                .hasPermanentMenuKey(ViewConfiguration.get(getApplication()));
    ...
    private void doConfigEngine(String encryptionKey, String encryptionMode) {
        ...
        workerThread.configEngine(vProfile, encryptionKey, encryptionMode);
    }
    ...
    // new User(workerThread.getEngineConfig().mUid, String.valueOf(workerThread.getEngineConfig().mUid)), msgStr);
    ...
    public void onVoiceChatClicked(View view) {
        // log.info("onVoiceChatClicked " + view + " " + mUidsList.size() + " video_status: " + mVideoMuted + "
    ...
    private SurfaceView getLocalView() {
        for (HashMap.Entry<Integer, SurfaceView> entry : mUidsList.entrySet()) {
            if (entry.getKey() == 0 || entry.getKey() == workerThread.getEngineConfig().mUid) {
    ...
    private void hideLocalView(boolean hide) {
        int uid = workerThread.getEngineConfig().mUid;
    ...
    private void doHideTargetView(int targetUid, boolean hide) {
        ...
        if (mLayoutType == LAYOUT_TYPE_DEFAULT) {
            ...
            if (bigBgUser.mUid == targetUid) { // big background is target view
                ...
                // log.warn("SmallVideoViewAdapter call notifyUiChanged " + mUidsList + " " + (bigBgUser.mUid &
                // 0xFFFFFFFFL) + " target: " + (targetUid & 0xFFFFFFFFL) + "==" + targetUid + " " + status);
    ...
    public void onVoiceMuteClicked(View view) {
        // log.info("onVoiceMuteClicked " + view + " " + mUidsList.size() + " video_status: " + mVideoMuted + "
        // audio_status: " + mAudioMuted);
        if (mUidsList.size() == 0) {
            return;
        }
        ...
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                if (useDefaultLayout) {
                    ...
                    // log.debug("doRenderRemoteUi LAYOUT_TYPE_SMALL " + (uid & 0xFFFFFFFFL) + " " + (bigBgUid &
                    // 0xFFFFFFFFL));
    ...
    private void doHandleExtraCallback(int type, Object... data) {
        ...
        case AGEventHandler.EVENT_TYPE_ON_USER_AUDIO_MUTED:
            ...
            if (mLayoutType == LAYOUT_TYPE_DEFAULT) {
                ...
                mGridVideoViewContainer.notifyUiChanged(mUidsList, workerThread.getEngineConfig().mUid, status, null);
            }
        ...
        case AGEventHandler.EVENT_TYPE_ON_USER_VIDEO_STATS:
            ...
            if (Constant.SHOW_VIDEO_INFO) {
                if (mLayoutType == LAYOUT_TYPE_DEFAULT) {
                    mGridVideoViewContainer.addVideoInfo(stats.uid, new VideoInfoData(stats.width, stats.height,
                            stats.delay, stats.receivedFrameRate, stats.receivedBitrate));
                    int uid = workerThread.getEngineConfig().mUid;
                    ...
                    mGridVideoViewContainer.addVideoInfo(uid, new VideoInfoData(width > height ? width : height,
                            width > height ? height : width, 0, Integer.valueOf(fps), Integer.valueOf(bitrate)));
                }
            } else {
        ...
        case AGEventHandler.EVENT_TYPE_ON_SPEAKER_STATS:
            ...
            if (mLayoutType == LAYOUT_TYPE_DEFAULT) {
                ...
                mGridVideoViewContainer.notifyUiChanged(mUidsList, workerThread.getEngineConfig().mUid, null, volume);
            }
    ...
    private void switchToDefaultVideoView() {
        ...
        mGridVideoViewContainer.initViewContainer(getApplicationContext(), workerThread.getEngineConfig().mUid,
                mUidsList);
    ...
    private void switchToSmallVideoView(int bigBgUid) {
        ...
        // TODO 对方挂掉之后重新连接，这里的slice的value值为null导致闪退
    ...
    private void bindToSmallVideoView(int exceptUid) {
        ...
        if (mSmallVideoViewAdapter == null) {
            create = true;
            mSmallVideoViewAdapter = new SmallVideoViewAdapter(this, workerThread.getEngineConfig().mUid, exceptUid,
        ...
        if (!create) {
            mSmallVideoViewAdapter.setLocalUid(workerThread.getEngineConfig().mUid);
